...
# 3. 修改settings.py，配置static文件夹：
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'static'), # 表示当请求/static/路径时，会到这里寻找文件。
)

# 4.修改index.html, 将相对路径修改成
<img class="fl" src="/static/images/logo.jpg"/></a>

# 这样，就可以显示了。
很奇怪，我用隐私窗口打开页面是正常，否则就是乱的。火狐有问题，chrome 没问题
```

![1553918739762](/home/bobo/Documents/django_xadmin/第六章：用户登录注册等.assets/1553918739762.png)

#### 登录页面配置

```
# 登录的html 文件也拷贝进来。并修改css等静态文件的路径。

# 修改url, 跳转到登录界面
    path('login/', TemplateView.as_view(template_name='login.html', name='login')),
    
# 然后我们要修修修改index.html　能够跳转到login.html 来
...
```
# users/views.py # 我们想要在用户是get方法的时候返回登录页面，在是post方法的时候，验证输入，我们这样配置：
...
![1553966177287](/home/bobo/Documents/django_xadmin/第六章：用户登录注册等.assets/1553966177287.png)



```
# 继续完善后台逻辑： 从前端取得值，判断能否登录。
...
![1553969440397](/home/bobo/Documents/django_xadmin/第六章：用户登录注册等.assets/1553969440397.png)
...
![1553971065093](/home/bobo/Documents/django_xadmin/第六章：用户登录注册等.assets/1553971065093.png)
